...
public class BlockAnimus extends BlockHorizontal
{
    public static final PropertyEnum<BlockAnimus.EnumPartType> PART = PropertyEnum.<BlockAnimus.EnumPartType>create("part", BlockAnimus.EnumPartType.class);
    ...
    public BlockAnimus()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(PART, BlockAnimus.EnumPartType.FOOT).withProperty(OCCUPIED, Boolean.valueOf(false)));
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            if (state.getValue(PART) != BlockAnimus.EnumPartType.HEAD)
            {
    ...
    {
        return state.getValue(PART) == BlockAnimus.EnumPartType.HEAD ? null : Items.BED;
    }
    ...
    {
        if (state.getValue(PART) == BlockAnimus.EnumPartType.FOOT)
        {
    ...
    {
        if (player.capabilities.isCreativeMode && state.getValue(PART) == BlockAnimus.EnumPartType.HEAD)
        {
            BlockPos blockpos = pos.offset(((EnumFacing)state.getValue(FACING)).getOpposite());
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return (meta & 8) > 0 ? this.getDefaultState().withProperty(PART, BlockAnimus.EnumPartType.HEAD).withProperty(FACING, enumfacing).withProperty(OCCUPIED, Boolean.valueOf((meta & 4) > 0)) : this.getDefaultState().withProperty(PART, BlockAnimus.EnumPartType.FOOT).withProperty(FACING, enumfacing);
    }
